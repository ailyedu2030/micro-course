...
export APP_SECURITY_FIELD_ENCRYPTION_KEY="${APP_SECURITY_FIELD_ENCRYPTION_KEY:-0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef}"
export APP_SECURITY_FIELD_ENCRYPTION_SALT="${APP_SECURITY_FIELD_ENCRYPTION_SALT:-0123456789abcdef}"
...
docker run -d --name "$API_CONTAINER" \
  ...
  -e APP_SECURITY_FIELD_ENCRYPTION_KEY="${APP_SECURITY_FIELD_ENCRYPTION_KEY:-0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef}" \
  -e APP_SECURITY_FIELD_ENCRYPTION_SALT="${APP_SECURITY_FIELD_ENCRYPTION_SALT:-0123456789abcdef}" \
