...
export APP_SECURITY_FIELD_ENCRYPTION_KEY="${APP_SECURITY_FIELD_ENCRYPTION_KEY:-local-dev-32-char-encryption-key-2026}"
export APP_SECURITY_FIELD_ENCRYPTION_SALT="${APP_SECURITY_FIELD_ENCRYPTION_SALT:-local-dev-salt-16chars}"
...
docker run -d --name "$API_CONTAINER" \
  ...
  -e APP_SECURITY_FIELD_ENCRYPTION_KEY="${APP_SECURITY_FIELD_ENCRYPTION_KEY:-local-dev-32-char-encryption-key-2026}" \
  -e APP_SECURITY_FIELD_ENCRYPTION_SALT="${APP_SECURITY_FIELD_ENCRYPTION_SALT:-local-dev-salt-16chars}" \
