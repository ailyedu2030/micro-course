...
public enum ErrorCode {
    ...
    SECTION_NOT_FOUND(7101, "课时不存在", 404),
    SECTION_TYPE_INVALID(7102, "课时类型非法", 400),
    SECTION_HAS_SLIDES(7103, "课时存在课件，无法删除", 400),
    ...
    DISCUSSION_POST_PENDING_REVIEW(10004, "帖子正在审核中，暂时无法操作", 400),
    DISCUSSION_POST_REJECTED(10005, "帖子已被驳回，无法操作", 400),
    ...
    MS_LEAD_EXISTS(17021, "微专业已有负责人，请使用LEAD继任功能", 409),
    MS_LEAD_CANNOT_REMOVE(17022, "负责人不能直接移除，请使用LEAD继任功能", 400),
    COURSE_NOT_IN_MS(17023, "课程不属于该微专业", 400),
