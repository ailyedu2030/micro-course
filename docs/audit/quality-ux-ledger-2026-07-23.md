...
- **Wave B 已完成**：`QX-P1C-001` ~ `QX-P1C-004` 全部关闭，后端事务/异步/文件副作用一致性基线已补齐
- 进入 **Wave C**：优先处理 `QX-P1C-005` ~ `QX-P1C-008`（学生高频学习链路 a11y / 键盘可达性）
- Wave C 完成标准：核心学习入口支持键盘与读屏，至少每条链路补 1 条交互回归证据
