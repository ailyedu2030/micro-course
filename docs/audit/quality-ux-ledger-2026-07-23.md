...
- **Wave C 已完成**：`QX-P1C-005` ~ `QX-P1C-008` 全部关闭，学生高频学习链路的键盘可达性与焦点可见性基线已补齐
- 进入 **Wave D**：优先处理 `QX-P1C-009` ~ `QX-P1C-010`（学习进度链路收敛 + 列表键盘增强稳定化）
- Wave D 完成标准：学习进度保存单一路径可验证，表格键盘增强在重渲染/销毁重建后仍稳定且无事件泄漏
