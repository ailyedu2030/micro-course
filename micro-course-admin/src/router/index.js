...
const routes = [
  ...
  { path: '/teacher/interactive', name: 'TeacherInteractiveOverview', component: () => import('../views/teacher/TeacherInteractiveOverview.vue'), meta: { requiresAuth: true, roles: ['TEACHER', 'ADMIN'], title: '互动课程管理' } },
  { path: '/teacher/offline', name: 'TeacherOfflineOverview', component: () => import('../views/teacher/TeacherOfflineOverview.vue'), meta: { requiresAuth: true, roles: ['TEACHER', 'ADMIN'], title: '线下课程管理' } },
