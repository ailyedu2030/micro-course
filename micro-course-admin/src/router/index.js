...
const routes = [
  ...
  { path: '/courses/:courseId/videos', name: 'CourseVideoList', component: () => import('../views/courses/VideoList.vue'), meta: { requiresAuth: true, roles: ['ADMIN', 'ACADEMIC', 'TEACHER'] } },
  ...
  // BUG-006 修复: 补齐 /admin/* 系列重定向，与 /admin/dashboard 风格一致
  ...
  { path: '/admin/exercises', redirect: '/exercises' },
  ...
  { path: '/admin/certificates', redirect: '/certificates' },
  { path: '/admin/badges', redirect: '/badges' },
  { path: '/admin/notifications', redirect: '/student/notifications' },
  { path: '/admin/discussions', redirect: '/discussions' },
  // 管理后台路由
  ...
  { path: '/teacher/courses/:courseId/chapters/:chapterId/manage-slides',
    ...
    component: () => import('../plugins/interactive/views/teacher/SlideManage.vue'),
    meta: { requiresAuth: true, roles: ['TEACHER', 'ADMIN'] } },
  { path: '/teacher/courses/:courseId/chapters/:chapterId/manage-offline',
    name: 'ChapterManageOffline',
    component: () => import('../views/teacher/TeacherOfflineSessions.vue'),
    meta: { requiresAuth: true, roles: ['TEACHER', 'ADMIN'] } },
