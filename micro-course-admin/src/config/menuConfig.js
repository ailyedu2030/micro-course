...
const TEACHER = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: '课程套餐', path: '/bundles', icon: 'Tickets' },
      { label: '章节管理', path: '/chapters', icon: 'List' },
      { label: '视频课程', path: '/teacher/courses?courseType=VIDEO', icon: 'VideoPlay' },
      { label: '互动课程', path: '/teacher/courses?courseType=INTERACTIVE', icon: 'Present' },
      { label: '线下课程', path: '/teacher/courses?courseType=OFFLINE', icon: 'Calendar' },
