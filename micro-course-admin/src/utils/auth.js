...
export function setToken(token) {
  try { localStorage.setItem(TOKEN_KEY, token) } catch (e) { if (e.name !== 'QuotaExceededError') console.warn('setToken failed:', e) }
}
...
export function setRefreshToken(token) {
  try { localStorage.setItem(REFRESH_TOKEN_KEY, token) } catch (e) { if (e.name !== 'QuotaExceededError') console.warn('setRefreshToken failed:', e) }
}
