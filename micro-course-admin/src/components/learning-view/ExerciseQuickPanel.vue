<!--
  章节快速练习入口（Round 11-3 从 LearningView.vue 拆分）
  ExerciseQuickPanel: 考试 Tab 的练习入口卡片 / 空状态
  Author: jackie
-->
<template>
  <div v-if="exerciseCount > 0" class="exam-entry-card">
