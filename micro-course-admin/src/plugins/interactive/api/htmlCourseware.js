...
export function getHtmlUnitBySection(courseId, sectionId) {
  return request({ method: 'GET', url: `/courses/${courseId}/html/sections/${sectionId}/unit` })
}

export function createHtmlUnit(courseId, sectionId, dto) {
  return request({ method: 'POST', url: `/courses/${courseId}/html/sections/${sectionId}/unit`, data: dto })
}

export function getHtmlUnit(courseId, unitId) {
  return request({ method: 'GET', url: `/courses/${courseId}/html/units/${unitId}` })
}

export function updateHtmlUnit(courseId, unitId, dto) {
  return request({ method: 'PUT', url: `/courses/${courseId}/html/units/${unitId}`, data: dto })
}
...
export function listActiveHtmlSegments(courseId, unitId) {
  return request({ method: 'GET', url: `/courses/${courseId}/html/units/${unitId}/segments` })
}

export function getActiveHtmlSegment(courseId, unitId, idx) {
  return request({ method: 'GET', url: `/courses/${courseId}/html/units/${unitId}/segments/${idx}` })
}

export function saveHtmlSegmentScript(courseId, unitId, idx, { scriptText, voice, ttsModel, segmentMarker, createdBy }) {
  return request({ method: 'PUT', url: `/courses/${courseId}/html/units/${unitId}/segments/${idx}`, data: { scriptText, voice, ttsModel, segmentMarker, createdBy } })
}

// === HTML 分段音频 ===

export function listHtmlSegmentAudios(courseId, segmentScriptId) {
  return request({ method: 'GET', url: `/courses/${courseId}/html/segments/${segmentScriptId}/audios` })
}

export function generateHtmlSegmentAudio(courseId, segmentScriptId, { voice, model, ttsParams }) {
  return request({ method: 'POST', url: `/courses/${courseId}/html/segments/${segmentScriptId}/audios`, data: { voice, model, ttsParams } })
}